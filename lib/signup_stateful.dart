        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              height: 280.0,
              child: SvgPicture.asset('assets/images/wel.svg',
                  fit: BoxFit.contain),
            ),
            const Center(child: Text('Sign In ', style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold),),),
            ...
            Center(child: RichText(text: const TextSpan(text: "I'm already member?",style: TextStyle(color: Colors.deepPurple),
            children: [
              TextSpan(text : ' Sign In',style: TextStyle(color: Colors.red,fontWeight: FontWeight.bold), ),
            ]),))
          ],
        ));
